...
namespace http_handler {
    ...
    public:
        explicit RequestHandler(model::Game& game, const fs::path& static_path, bool is_tick_automatic)
            : game_{ game }, static_path_{ static_path }, is_tick_automatic_{ is_tick_automatic } {
        }
        ...
        RequestHandler(RequestHandler&& other) noexcept
            ...
            is_tick_automatic_{ other.is_tick_automatic_ } {
        }
