...
void GameSession::Tick(double delta_time) {
    ...
    for (auto& player : players_) {
        ...
        // Разбиваем движение на небольшие шаги для точного определения коллизий
        const double max_step = 0.1; // Максимальный размер шага
        ...
        while (remaining_time > 0.0) {
            ...
            if (can_move) {
                ...
                break; // Прекращаем движение после столкновения
            }
        }
    }
}
