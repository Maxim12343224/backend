...
namespace model {
    ...
    public:
        ...
        void SetPosition(Point p) noexcept {
            position_ = p;
            // Не обновляем время при изменении позиции!
        }
